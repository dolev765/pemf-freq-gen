...
/**
 * STRIPPED DOWN VERSION - MAGNETOMETER ONLY
 * 
 * This is SensorInput.java with ALL non-magnetometer code removed.
 * Only magnetometer (TYPE_MAGNETIC_FIELD) functionality remains.
 */
public class SensorInput implements SensorEventListener, Serializable {

    public int type; // Always Sensor.TYPE_MAGNETIC_FIELD or TYPE_MAGNETIC_FIELD_UNCALIBRATED
    public SensorName sensorName; // Always magnetic_field
    ...
    // ONLY MAGNETOMETER - all other sensors removed
